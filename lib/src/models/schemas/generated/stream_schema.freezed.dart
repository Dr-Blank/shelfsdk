...
/// @nodoc
abstract class _$$StreamSchemaImplCopyWith<$Res>
    implements $StreamSchemaCopyWith<$Res> {
  factory _$$StreamSchemaImplCopyWith(
          _$StreamSchemaImpl value, $Res Function(_$StreamSchemaImpl) then) =
      __$$StreamSchemaImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$StreamSchemaImplCopyWithImpl<$Res>
    extends _$StreamSchemaCopyWithImpl<$Res, _$StreamSchemaImpl>
    implements _$$StreamSchemaImplCopyWith<$Res> {
  __$$StreamSchemaImplCopyWithImpl(
  ...
  $Res call({
    ...
    return _then(_$StreamSchemaImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$StreamSchemaImpl implements _StreamSchema {
  const _$StreamSchemaImpl(
      {required this.id,
  ...
  factory _$StreamSchemaImpl.fromJson(Map<String, dynamic> json) =>
      _$$StreamSchemaImplFromJson(json);
  ...
  _$$StreamSchemaImplCopyWith<_$StreamSchemaImpl> get copyWith =>
      __$$StreamSchemaImplCopyWithImpl<_$StreamSchemaImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$StreamSchemaImplToJson(
      this,
    );
  }
}
...
abstract class _StreamSchema implements StreamSchema {
  const factory _StreamSchema(
      ...
      required final bool isTranscodeComplete}) = _$StreamSchemaImpl;

  factory _StreamSchema.fromJson(Map<String, dynamic> json) =
      _$StreamSchemaImpl.fromJson;
