...
@jsonConverters
class _$MediaProgressImpl extends _MediaProgress {
...
abstract class _MediaProgress extends MediaProgress {
  const factory _MediaProgress(
      ...
      final DateTime? finishedAt}) = _$MediaProgressImpl;
...
/// @nodoc
abstract class _$$MediaProgressWithMediaImplCopyWith<$Res>
    implements $MediaProgressCopyWith<$Res> {
  factory _$$MediaProgressWithMediaImplCopyWith(
          _$MediaProgressWithMediaImpl value,
          $Res Function(_$MediaProgressWithMediaImpl) then) =
      __$$MediaProgressWithMediaImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$MediaProgressWithMediaImplCopyWithImpl<$Res>
    extends _$MediaProgressCopyWithImpl<$Res, _$MediaProgressWithMediaImpl>
    implements _$$MediaProgressWithMediaImplCopyWith<$Res> {
  __$$MediaProgressWithMediaImplCopyWithImpl(
      _$MediaProgressWithMediaImpl _value,
  ...
  $Res call({
    ...
    return _then(_$MediaProgressWithMediaImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
@jsonConverters
class _$MediaProgressWithMediaImpl extends MediaProgressWithMedia {
  const _$MediaProgressWithMediaImpl(
      {required this.id,
      required this.libraryItemId,
      this.episodeId,
      required this.duration,
  ...
  factory _$MediaProgressWithMediaImpl.fromJson(Map<String, dynamic> json) =>
      _$$MediaProgressWithMediaImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$MediaProgressWithMediaImpl &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.libraryItemId, libraryItemId) ||
                other.libraryItemId == libraryItemId) &&
            (identical(other.episodeId, episodeId) ||
  ...
  _$$MediaProgressWithMediaImplCopyWith<_$MediaProgressWithMediaImpl>
      get copyWith => __$$MediaProgressWithMediaImplCopyWithImpl<
          _$MediaProgressWithMediaImpl>(this, _$identity);
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$MediaProgressWithMediaImplToJson(
      this,
    );
  }
}
