...
/// @nodoc
abstract class _$$AudioMetaTagsImplCopyWith<$Res>
    implements $AudioMetaTagsCopyWith<$Res> {
  factory _$$AudioMetaTagsImplCopyWith(
          _$AudioMetaTagsImpl value, $Res Function(_$AudioMetaTagsImpl) then) =
      __$$AudioMetaTagsImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? tagAlbum,
...
/// @nodoc
class __$$AudioMetaTagsImplCopyWithImpl<$Res>
    extends _$AudioMetaTagsCopyWithImpl<$Res, _$AudioMetaTagsImpl>
    implements _$$AudioMetaTagsImplCopyWith<$Res> {
  __$$AudioMetaTagsImplCopyWithImpl(
  ...
  $Res call({
    ...
    return _then(_$AudioMetaTagsImpl(
      tagAlbum: freezed == tagAlbum
          ? _value.tagAlbum
          : tagAlbum // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$AudioMetaTagsImpl implements _AudioMetaTags {
  const _$AudioMetaTagsImpl(
      {this.tagAlbum,
      this.tagArtist,
      this.tagGenre,
      this.tagTitle,
  ...
  factory _$AudioMetaTagsImpl.fromJson(Map<String, dynamic> json) =>
      _$$AudioMetaTagsImplFromJson(json);
  ...
  _$$AudioMetaTagsImplCopyWith<_$AudioMetaTagsImpl> get copyWith =>
      __$$AudioMetaTagsImplCopyWithImpl<_$AudioMetaTagsImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$AudioMetaTagsImplToJson(
      this,
    );
  }
}
...
abstract class _AudioMetaTags implements AudioMetaTags {
  const factory _AudioMetaTags(
      ...
      final String? tagMusicBrainzAlbumId,
      final String? tagMusicBrainzAlbumArtistId,
      final String? tagMusicBrainzArtistId}) = _$AudioMetaTagsImpl;

  factory _AudioMetaTags.fromJson(Map<String, dynamic> json) =
      _$AudioMetaTagsImpl.fromJson;
