...
/// @nodoc
abstract class _$$RssFeedEpisodeImplCopyWith<$Res>
    implements $RssFeedEpisodeCopyWith<$Res> {
  factory _$$RssFeedEpisodeImplCopyWith(_$RssFeedEpisodeImpl value,
          $Res Function(_$RssFeedEpisodeImpl) then) =
      __$$RssFeedEpisodeImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$RssFeedEpisodeImplCopyWithImpl<$Res>
    extends _$RssFeedEpisodeCopyWithImpl<$Res, _$RssFeedEpisodeImpl>
    implements _$$RssFeedEpisodeImplCopyWith<$Res> {
  __$$RssFeedEpisodeImplCopyWithImpl(
  ...
  $Res call({
    ...
    return _then(_$RssFeedEpisodeImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
@jsonConverters
class _$RssFeedEpisodeImpl implements _RssFeedEpisode {
  const _$RssFeedEpisodeImpl(
      {required this.id,
      required this.title,
  ...
  factory _$RssFeedEpisodeImpl.fromJson(Map<String, dynamic> json) =>
      _$$RssFeedEpisodeImplFromJson(json);
  ...
  _$$RssFeedEpisodeImplCopyWith<_$RssFeedEpisodeImpl> get copyWith =>
      __$$RssFeedEpisodeImplCopyWithImpl<_$RssFeedEpisodeImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RssFeedEpisodeImplToJson(
      this,
    );
  }
}
...
abstract class _RssFeedEpisode implements RssFeedEpisode {
  const factory _RssFeedEpisode(
      ...
      required final String fullPath}) = _$RssFeedEpisodeImpl;

  factory _RssFeedEpisode.fromJson(Map<String, dynamic> json) =
      _$RssFeedEpisodeImpl.fromJson;
