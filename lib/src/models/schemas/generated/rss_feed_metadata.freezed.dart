...
/// @nodoc
abstract class _$$RssFeedMetadataImplCopyWith<$Res>
    implements $RssFeedMetadataCopyWith<$Res> {
  factory _$$RssFeedMetadataImplCopyWith(_$RssFeedMetadataImpl value,
          $Res Function(_$RssFeedMetadataImpl) then) =
      __$$RssFeedMetadataImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String title,
...
/// @nodoc
class __$$RssFeedMetadataImplCopyWithImpl<$Res>
    extends _$RssFeedMetadataCopyWithImpl<$Res, _$RssFeedMetadataImpl>
    implements _$$RssFeedMetadataImplCopyWith<$Res> {
  __$$RssFeedMetadataImplCopyWithImpl(
  ...
  $Res call({
    ...
    return _then(_$RssFeedMetadataImpl(
      title: null == title
          ? _value.title
          : title // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$RssFeedMetadataImpl implements _RssFeedMetadata {
  const _$RssFeedMetadataImpl(
      {required this.title,
  ...
  factory _$RssFeedMetadataImpl.fromJson(Map<String, dynamic> json) =>
      _$$RssFeedMetadataImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RssFeedMetadataImpl &&
  ...
  _$$RssFeedMetadataImplCopyWith<_$RssFeedMetadataImpl> get copyWith =>
      __$$RssFeedMetadataImplCopyWithImpl<_$RssFeedMetadataImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RssFeedMetadataImplToJson(
      this,
    );
  }
}
...
abstract class _RssFeedMetadata implements RssFeedMetadata {
  const factory _RssFeedMetadata(
      ...
      required final bool explicit}) = _$RssFeedMetadataImpl;

  factory _RssFeedMetadata.fromJson(Map<String, dynamic> json) =
      _$RssFeedMetadataImpl.fromJson;
