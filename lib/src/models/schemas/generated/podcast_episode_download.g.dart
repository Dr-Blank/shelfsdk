...
_$PodcastEpisodeDownloadImpl _$$PodcastEpisodeDownloadImplFromJson(
...
Map<String, dynamic> _$$PodcastEpisodeDownloadImplToJson(
        _$PodcastEpisodeDownloadImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
