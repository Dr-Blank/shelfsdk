...
/// @nodoc
abstract class _$$GetLibrarysSeriesResponseImplCopyWith<$Res>
    implements $GetLibrarysSeriesResponseCopyWith<$Res> {
  factory _$$GetLibrarysSeriesResponseImplCopyWith(
          _$GetLibrarysSeriesResponseImpl value,
          $Res Function(_$GetLibrarysSeriesResponseImpl) then) =
      __$$GetLibrarysSeriesResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {List<Series> results,
...
/// @nodoc
class __$$GetLibrarysSeriesResponseImplCopyWithImpl<$Res>
    extends _$GetLibrarysSeriesResponseCopyWithImpl<$Res,
        _$GetLibrarysSeriesResponseImpl>
    implements _$$GetLibrarysSeriesResponseImplCopyWith<$Res> {
  __$$GetLibrarysSeriesResponseImplCopyWithImpl(
      _$GetLibrarysSeriesResponseImpl _value,
  ...
  $Res call({
    ...
    return _then(_$GetLibrarysSeriesResponseImpl(
      results: null == results
          ? _value._results
          : results // ignore: cast_nullable_to_non_nullable
              as List<Series>,
...
@JsonSerializable()
@FilterConverter()
class _$GetLibrarysSeriesResponseImpl implements _GetLibrarysSeriesResponse {
  const _$GetLibrarysSeriesResponseImpl(
  ...
  factory _$GetLibrarysSeriesResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$GetLibrarysSeriesResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetLibrarysSeriesResponseImpl &&
  ...
  _$$GetLibrarysSeriesResponseImplCopyWith<_$GetLibrarysSeriesResponseImpl>
      get copyWith => __$$GetLibrarysSeriesResponseImplCopyWithImpl<
          _$GetLibrarysSeriesResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GetLibrarysSeriesResponseImplToJson(
      this,
    );
  }
}
...
abstract class _GetLibrarysSeriesResponse implements GetLibrarysSeriesResponse {
  const factory _GetLibrarysSeriesResponse(
      ...
      required final String include}) = _$GetLibrarysSeriesResponseImpl;

  factory _GetLibrarysSeriesResponse.fromJson(Map<String, dynamic> json) =
      _$GetLibrarysSeriesResponseImpl.fromJson;
