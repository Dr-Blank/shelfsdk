...
/// @nodoc
abstract class _$$GetLibrarysItemsResponseImplCopyWith<$Res>
    implements $GetLibrarysItemsResponseCopyWith<$Res> {
  factory _$$GetLibrarysItemsResponseImplCopyWith(
          _$GetLibrarysItemsResponseImpl value,
          $Res Function(_$GetLibrarysItemsResponseImpl) then) =
      __$$GetLibrarysItemsResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {List<LibraryItem> results,
...
/// @nodoc
class __$$GetLibrarysItemsResponseImplCopyWithImpl<$Res>
    extends _$GetLibrarysItemsResponseCopyWithImpl<$Res,
        _$GetLibrarysItemsResponseImpl>
    implements _$$GetLibrarysItemsResponseImplCopyWith<$Res> {
  __$$GetLibrarysItemsResponseImplCopyWithImpl(
      _$GetLibrarysItemsResponseImpl _value,
      $Res Function(_$GetLibrarysItemsResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetLibrarysItemsResponseImpl(
      results: null == results
          ? _value._results
          : results // ignore: cast_nullable_to_non_nullable
              as List<LibraryItem>,
...
@JsonSerializable()
@FilterConverter()
class _$GetLibrarysItemsResponseImpl implements _GetLibrarysItemsResponse {
  const _$GetLibrarysItemsResponseImpl(
  ...
  factory _$GetLibrarysItemsResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$GetLibrarysItemsResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetLibrarysItemsResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetLibrarysItemsResponseImplCopyWith<_$GetLibrarysItemsResponseImpl>
      get copyWith => __$$GetLibrarysItemsResponseImplCopyWithImpl<
          _$GetLibrarysItemsResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GetLibrarysItemsResponseImplToJson(
      this,
    );
  }
}
...
abstract class _GetLibrarysItemsResponse implements GetLibrarysItemsResponse {
  const factory _GetLibrarysItemsResponse(
      ...
      required final String include}) = _$GetLibrarysItemsResponseImpl;

  factory _GetLibrarysItemsResponse.fromJson(Map<String, dynamic> json) =
      _$GetLibrarysItemsResponseImpl.fromJson;
