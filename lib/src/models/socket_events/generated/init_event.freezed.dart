...
class __$$InitEventImplCopyWithImpl<$Res>
    extends _$InitEventCopyWithImpl<$Res, _$InitEventImpl>
...
class _$InitEventImpl implements _InitEvent {
  ...
  factory _$InitEventImpl.fromJson(Map<String, dynamic> json) =>
      _$$InitEventImplFromJson(json);
...
abstract class _InitEvent implements InitEvent {
  const factory _InitEvent(
      ...
      required final List<String> librariesScanning,
      final List<User>? usersOnline}) = _$InitEventImpl;

  factory _InitEvent.fromJson(Map<String, dynamic> json) =
      _$InitEventImpl.fromJson;
